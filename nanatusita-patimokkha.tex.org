...
\ifasixversion\begin{packedenumerate}\fi
...
\ifasixversion\end{packedenumerate}\fi
...
\setbeforesubsecskip{-0.5ex \@plus -1ex \@minus -.2ex}
\setaftersubsecskip{0.01ex \@plus -.5ex \@minus -.2ex}

% Alters space before and after subsubsections
\setbeforesubsubsecskip{-0.5ex \@plus -1ex \@minus -.2ex}
\setaftersubsubsecskip{0.01ex}
\fi
...
{%
  ...
  \ifasixversion\fontsize{8}{11}\selectfont\fi%

  \setlength{\parindent}{0pt}%
  \raggedright\label{copyright-details}%
  \ifafiveversion\setlength{\parskip}{4.5pt}\fi%
  \ifasixversion\setlength{\parskip}{2.5pt}\fi%

  {\centering

    \ifafiveversion{\fontsize{25}{18}\selectfont \ccbyncnd}\fi
    \ifasixversion{\fontsize{18}{10}\selectfont \ccbyncnd}\fi
